...
public class ReadingHistory extends Fragment {
View v;
    ListView lst;
    String uid;
    String reading[];
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
      return  v=inflater.inflate(R.layout.readinghistory,container,false);
    }
    ...
    private class UserViewdata extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                LevelAdapter adapter = new LevelAdapter(getActivity(),reading,date);
